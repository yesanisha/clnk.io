          ...
          <View style={styles.options}>
            ...
            >
              <View style={styles.optionContent}>
                <Text style={[styles.optionText, currentMode === 'Links' && styles.optionTextActive]}>🔗 Links</Text>
            ...
            >
              <View style={styles.optionContent}>
                <Text style={[styles.optionText, currentMode === 'URL' && styles.optionTextActive]}>🔍 URL</Text>
